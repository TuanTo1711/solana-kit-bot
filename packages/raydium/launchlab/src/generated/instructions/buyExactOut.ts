...
export const BUY_EXACT_OUT_DISCRIMINATOR = new Uint8Array([24, 211, 116, 40, 105, 3, 153, 56])

export function getBuyExactOutDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BUY_EXACT_OUT_DISCRIMINATOR)
}
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getBuyExactOutInstructionDataEncoder().encode(args as BuyExactOutInstructionDataArgs),
