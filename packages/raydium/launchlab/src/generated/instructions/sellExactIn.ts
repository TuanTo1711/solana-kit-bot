...
export const SELL_EXACT_IN_DISCRIMINATOR = new Uint8Array([149, 39, 222, 155, 211, 124, 152, 26])

export function getSellExactInDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SELL_EXACT_IN_DISCRIMINATOR)
}
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getSellExactInInstructionDataEncoder().encode(args as SellExactInInstructionDataArgs),
