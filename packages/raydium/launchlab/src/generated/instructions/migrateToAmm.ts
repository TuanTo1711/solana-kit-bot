...
export const MIGRATE_TO_AMM_DISCRIMINATOR = new Uint8Array([207, 82, 192, 145, 254, 207, 145, 223])
...
> {
  ...
  if (!accounts.ammAuthority.value) {
    accounts.ammAuthority.value = await getProgramDerivedAddress({
      ...
      seeds: [
        getBytesEncoder().encode(
          new Uint8Array([97, 109, 109, 32, 97, 117, 116, 104, 111, 114, 105, 116, 121])
        ),
      ],
    })
  }
  if (!accounts.ammOpenOrders.value) {
    accounts.ammOpenOrders.value = await getProgramDerivedAddress({
      ...
      seeds: [
        ...
        getBytesEncoder().encode(
          new Uint8Array([
            111, 112, 101, 110, 95, 111, 114, 100, 101, 114, 95, 97, 115, 115, 111, 99, 105, 97,
  ...
  if (!accounts.ammLpMint.value) {
    accounts.ammLpMint.value = await getProgramDerivedAddress({
      ...
      seeds: [
        ...
        getBytesEncoder().encode(
          new Uint8Array([
            108, 112, 95, 109, 105, 110, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101, 100, 95,
            115, 101, 101, 100,
          ])
        ),
      ],
  ...
  if (!accounts.ammBaseVault.value) {
    accounts.ammBaseVault.value = await getProgramDerivedAddress({
      ...
      seeds: [
        ...
        getBytesEncoder().encode(
          new Uint8Array([
            99, 111, 105, 110, 95, 118, 97, 117, 108, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116,
            101, 100, 95, 115, 101, 101, 100,
          ])
        ),
      ],
    })
  ...
  if (!accounts.ammQuoteVault.value) {
    accounts.ammQuoteVault.value = await getProgramDerivedAddress({
      ...
      seeds: [
        ...
        getBytesEncoder().encode(
          new Uint8Array([
            112, 99, 95, 118, 97, 117, 108, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101, 100,
            95, 115, 101, 101, 100,
          ])
        ),
      ],
  ...
  if (!accounts.ammTargetOrders.value) {
    accounts.ammTargetOrders.value = await getProgramDerivedAddress({
      ...
      seeds: [
        ...
        getBytesEncoder().encode(
          new Uint8Array([
            116, 97, 114, 103, 101, 116, 95, 97, 115, 115, 111, 99, 105, 97, 116, 101, 100, 95, 115,
            101, 101, 100,
          ])
        ),
      ],
  ...
  if (!accounts.ammConfig.value) {
    accounts.ammConfig.value = await getProgramDerivedAddress({
      ...
      seeds: [
        getBytesEncoder().encode(
          new Uint8Array([
            97, 109, 109, 95, 99, 111, 110, 102, 105, 103, 95, 97, 99, 99, 111, 117, 110, 116, 95,
            115, 101, 101, 100,
          ])
        ),
      ],
