...
export function getMigrateToCpswapDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(MIGRATE_TO_CPSWAP_DISCRIMINATOR)
}
...
> = Instruction<TProgram> &
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountCpswapPool extends string ? WritableAccount<TAccountCpswapPool> : TAccountCpswapPool,
  ...
  if (!accounts.lockAuthority.value) {
    accounts.lockAuthority.value = await getProgramDerivedAddress({
      ...
      seeds: [
        getBytesEncoder().encode(
          new Uint8Array([
            108, 111, 99, 107, 95, 99, 112, 95, 97, 117, 116, 104, 111, 114, 105, 116, 121, 95, 115,
            101, 101, 100,
          ])
        ),
      ],
