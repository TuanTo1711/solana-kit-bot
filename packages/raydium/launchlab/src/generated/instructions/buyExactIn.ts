...
export const BUY_EXACT_IN_DISCRIMINATOR = new Uint8Array([250, 234, 13, 123, 213, 156, 19, 236])

export function getBuyExactInDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BUY_EXACT_IN_DISCRIMINATOR)
}
...
> {
  return combineCodec(getBuyExactInInstructionDataEncoder(), getBuyExactInInstructionDataDecoder())
}
