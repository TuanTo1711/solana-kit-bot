...
export function curveParams(
  kind: 'Constant',
  data: GetDiscriminatedUnionVariantContent<CurveParamsArgs, '__kind', 'Constant'>
...
export function curveParams<K extends CurveParamsArgs['__kind'], Data>(kind: K, data?: Data) {
