...
export function getClaimVestedEventCodec(): FixedSizeCodec<ClaimVestedEventArgs, ClaimVestedEvent> {
  return combineCodec(getClaimVestedEventEncoder(), getClaimVestedEventDecoder())
}
