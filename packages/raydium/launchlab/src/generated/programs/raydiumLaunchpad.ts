...
export function identifyRaydiumLaunchpadAccount(
  ...
  throw new Error('The provided account could not be identified as a raydiumLaunchpad account.')
}
...
export function identifyRaydiumLaunchpadInstruction(
  ...
  if (
    containsBytes(
      data,
      fixEncoderSize(getBytesEncoder(), 8).encode(new Uint8Array([95, 200, 71, 34, 8, 9, 11, 166])),
      0
    )
  ) {
