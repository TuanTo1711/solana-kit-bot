...
let raydiumLaunchpadErrorMessages: Record<RaydiumLaunchpadError, string> | undefined
...
export function getRaydiumLaunchpadErrorMessage(code: RaydiumLaunchpadError): string {
  if (process.env['NODE_ENV'] !== 'production') {
    return (raydiumLaunchpadErrorMessages as Record<RaydiumLaunchpadError, string>)[code]
  }

  return 'Error message not available in production bundles.'
}

export function isRaydiumLaunchpadError<TProgramErrorCode extends RaydiumLaunchpadError>(
  error: unknown,
  transactionMessage: {
