...
export const VESTING_RECORD_DISCRIMINATOR = new Uint8Array([106, 243, 221, 205, 230, 126, 85, 83])

export function getVestingRecordDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(VESTING_RECORD_DISCRIMINATOR)
}
...
export function getVestingRecordCodec(): FixedSizeCodec<VestingRecordArgs, VestingRecord> {
