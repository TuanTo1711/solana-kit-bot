...
export const ADMIN_MINT_MSOL_DISCRIMINATOR = new Uint8Array([140, 202, 57, 195, 97, 213, 168, 19])

export function getAdminMintMsolDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(ADMIN_MINT_MSOL_DISCRIMINATOR)
}

export type AdminMintMsolInstruction<
...
export type AdminMintMsolInstructionData = {
  discriminator: ReadonlyUint8Array
  version: number
  amount: bigint
}

export type AdminMintMsolInstructionDataArgs = {
  version: number
  amount: number | bigint
}

export function getAdminMintMsolInstructionDataEncoder(): FixedSizeEncoder<AdminMintMsolInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({ ...value, discriminator: ADMIN_MINT_MSOL_DISCRIMINATOR })
  )
}

export function getAdminMintMsolInstructionDataDecoder(): FixedSizeDecoder<AdminMintMsolInstructionData> {
...
export function getAdminMintMsolInstructionDataCodec(): FixedSizeCodec<
  AdminMintMsolInstructionDataArgs,
  AdminMintMsolInstructionData
> {
  return combineCodec(
    getAdminMintMsolInstructionDataEncoder(),
    getAdminMintMsolInstructionDataDecoder()
  )
}

export type AdminMintMsolAsyncInput<
...
> = {
  ...
  version: AdminMintMsolInstructionDataArgs['version']
  amount: AdminMintMsolInstructionDataArgs['amount']
}

export async function getAdminMintMsolInstructionAsync<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAdminMintMsolInstructionDataEncoder().encode(args as AdminMintMsolInstructionDataArgs),
  } as AdminMintMsolInstruction<
    TProgramAddress,
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
...
export type AdminMintMsolInput<
  TAccountTokenProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountPayer extends string = string,
  TAccountAdmin extends string = string,
...
export function getAdminMintMsolInstruction<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
export type ParsedAdminMintMsolInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AdminMintMsolInstructionData
}

export function parseAdminMintMsolInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAdminMintMsolInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAdminMintMsolInstructionDataDecoder().decode(instruction.data),
  }
}
