...
export const ADMIN_REPAY_SOL_DISCRIMINATOR = new Uint8Array([136, 61, 48, 232, 166, 26, 207, 46])

export function getAdminRepaySolDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(ADMIN_REPAY_SOL_DISCRIMINATOR)
}

export type AdminRepaySolInstruction<
...
export type AdminRepaySolInstructionData = {
  discriminator: ReadonlyUint8Array
  version: number
  amount: bigint
}

export type AdminRepaySolInstructionDataArgs = {
  version: number
  amount: number | bigint
}

export function getAdminRepaySolInstructionDataEncoder(): FixedSizeEncoder<AdminRepaySolInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({ ...value, discriminator: ADMIN_REPAY_SOL_DISCRIMINATOR })
  )
}

export function getAdminRepaySolInstructionDataDecoder(): FixedSizeDecoder<AdminRepaySolInstructionData> {
...
export function getAdminRepaySolInstructionDataCodec(): FixedSizeCodec<
  AdminRepaySolInstructionDataArgs,
  AdminRepaySolInstructionData
> {
  return combineCodec(
    getAdminRepaySolInstructionDataEncoder(),
    getAdminRepaySolInstructionDataDecoder()
  )
}

export type AdminRepaySolAsyncInput<
...
> = {
  ...
  version: AdminRepaySolInstructionDataArgs['version']
  amount: AdminRepaySolInstructionDataArgs['amount']
}

export async function getAdminRepaySolInstructionAsync<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAdminRepaySolInstructionDataEncoder().encode(args as AdminRepaySolInstructionDataArgs),
  } as AdminRepaySolInstruction<
    TProgramAddress,
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
...
export type AdminRepaySolInput<
  TAccountTokenProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountPayer extends string = string,
  TAccountAdmin extends string = string,
...
export function getAdminRepaySolInstruction<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
export type ParsedAdminRepaySolInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AdminRepaySolInstructionData
}

export function parseAdminRepaySolInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAdminRepaySolInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAdminRepaySolInstructionDataDecoder().decode(instruction.data),
  }
}
