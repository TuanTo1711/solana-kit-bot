...
export const ADMIN_CLAIM_STANDARD_CREATOR_TRADING_FEES_DISCRIMINATOR = new Uint8Array([
  182, 39, 168, 25, 96, 63, 76, 17,
])

export function getAdminClaimStandardCreatorTradingFeesDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ADMIN_CLAIM_STANDARD_CREATOR_TRADING_FEES_DISCRIMINATOR
  )
}

export type AdminClaimStandardCreatorTradingFeesInstruction<
...
export type AdminClaimStandardCreatorTradingFeesInstructionData = {
  discriminator: ReadonlyUint8Array
  amount: bigint
}

export type AdminClaimStandardCreatorTradingFeesInstructionDataArgs = {
  amount: number | bigint
}

export function getAdminClaimStandardCreatorTradingFeesInstructionDataEncoder(): FixedSizeEncoder<AdminClaimStandardCreatorTradingFeesInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({
      ...value,
      discriminator: ADMIN_CLAIM_STANDARD_CREATOR_TRADING_FEES_DISCRIMINATOR,
    })
  )
}

export function getAdminClaimStandardCreatorTradingFeesInstructionDataDecoder(): FixedSizeDecoder<AdminClaimStandardCreatorTradingFeesInstructionData> {
...
export function getAdminClaimStandardCreatorTradingFeesInstructionDataCodec(): FixedSizeCodec<
  AdminClaimStandardCreatorTradingFeesInstructionDataArgs,
  AdminClaimStandardCreatorTradingFeesInstructionData
> {
  return combineCodec(
    getAdminClaimStandardCreatorTradingFeesInstructionDataEncoder(),
    getAdminClaimStandardCreatorTradingFeesInstructionDataDecoder()
  )
}

export type AdminClaimStandardCreatorTradingFeesAsyncInput<
...
> = {
  ...
  amount: AdminClaimStandardCreatorTradingFeesInstructionDataArgs['amount']
}

export async function getAdminClaimStandardCreatorTradingFeesInstructionAsync<
  TAccountTokenAProgram extends string,
  TAccountTokenBProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSystemProgram extends string,
...
>(
  input: AdminClaimStandardCreatorTradingFeesAsyncInput<
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
    TAccountSystemProgram,
  ...
  AdminClaimStandardCreatorTradingFeesInstruction<
    TProgramAddress,
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAdminClaimStandardCreatorTradingFeesInstructionDataEncoder().encode(
      args as AdminClaimStandardCreatorTradingFeesInstructionDataArgs
    ),
  } as AdminClaimStandardCreatorTradingFeesInstruction<
    TProgramAddress,
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
...
export type AdminClaimStandardCreatorTradingFeesInput<
  TAccountTokenAProgram extends string = string,
  TAccountTokenBProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountSystemProgram extends string = string,
...
export function getAdminClaimStandardCreatorTradingFeesInstruction<
  TAccountTokenAProgram extends string,
  TAccountTokenBProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSystemProgram extends string,
  ...
  TProgramAddress extends Address = typeof HEAVEN_PROGRAM_ADDRESS,
>(
  input: AdminClaimStandardCreatorTradingFeesInput<
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
    TAccountSystemProgram,
...
export type ParsedAdminClaimStandardCreatorTradingFeesInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AdminClaimStandardCreatorTradingFeesInstructionData
}

export function parseAdminClaimStandardCreatorTradingFeesInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAdminClaimStandardCreatorTradingFeesInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAdminClaimStandardCreatorTradingFeesInstructionDataDecoder().decode(instruction.data),
  }
}
