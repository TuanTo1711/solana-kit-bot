...
export const CLAIM_STANDARD_PROTOCOL_TRADING_FEES_DISCRIMINATOR = new Uint8Array([
  84, 206, 140, 245, 63, 212, 64, 237,
])

export function getClaimStandardProtocolTradingFeesDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLAIM_STANDARD_PROTOCOL_TRADING_FEES_DISCRIMINATOR
  )
}

export type ClaimStandardProtocolTradingFeesInstruction<
...
export type ClaimStandardProtocolTradingFeesInstructionData = {
  discriminator: ReadonlyUint8Array
  amount: bigint
}

export type ClaimStandardProtocolTradingFeesInstructionDataArgs = {
  amount: number | bigint
}

export function getClaimStandardProtocolTradingFeesInstructionDataEncoder(): FixedSizeEncoder<ClaimStandardProtocolTradingFeesInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({
      ...value,
      discriminator: CLAIM_STANDARD_PROTOCOL_TRADING_FEES_DISCRIMINATOR,
    })
  )
}

export function getClaimStandardProtocolTradingFeesInstructionDataDecoder(): FixedSizeDecoder<ClaimStandardProtocolTradingFeesInstructionData> {
...
export function getClaimStandardProtocolTradingFeesInstructionDataCodec(): FixedSizeCodec<
  ClaimStandardProtocolTradingFeesInstructionDataArgs,
  ClaimStandardProtocolTradingFeesInstructionData
> {
  return combineCodec(
    getClaimStandardProtocolTradingFeesInstructionDataEncoder(),
    getClaimStandardProtocolTradingFeesInstructionDataDecoder()
  )
}

export type ClaimStandardProtocolTradingFeesAsyncInput<
...
> = {
  ...
  amount: ClaimStandardProtocolTradingFeesInstructionDataArgs['amount']
}

export async function getClaimStandardProtocolTradingFeesInstructionAsync<
  TAccountTokenAProgram extends string,
  TAccountTokenBProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSystemProgram extends string,
...
>(
  input: ClaimStandardProtocolTradingFeesAsyncInput<
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
    TAccountSystemProgram,
  ...
  ClaimStandardProtocolTradingFeesInstruction<
    TProgramAddress,
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getClaimStandardProtocolTradingFeesInstructionDataEncoder().encode(
      args as ClaimStandardProtocolTradingFeesInstructionDataArgs
    ),
  } as ClaimStandardProtocolTradingFeesInstruction<
    TProgramAddress,
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
...
export type ClaimStandardProtocolTradingFeesInput<
  TAccountTokenAProgram extends string = string,
  TAccountTokenBProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountSystemProgram extends string = string,
...
export function getClaimStandardProtocolTradingFeesInstruction<
  TAccountTokenAProgram extends string,
  TAccountTokenBProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSystemProgram extends string,
  ...
  TProgramAddress extends Address = typeof HEAVEN_PROGRAM_ADDRESS,
>(
  input: ClaimStandardProtocolTradingFeesInput<
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
    TAccountSystemProgram,
...
export type ParsedClaimStandardProtocolTradingFeesInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: ClaimStandardProtocolTradingFeesInstructionData
}

export function parseClaimStandardProtocolTradingFeesInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedClaimStandardProtocolTradingFeesInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getClaimStandardProtocolTradingFeesInstructionDataDecoder().decode(instruction.data),
  }
}
