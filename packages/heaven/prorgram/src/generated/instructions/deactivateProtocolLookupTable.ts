...
export const DEACTIVATE_PROTOCOL_LOOKUP_TABLE_DISCRIMINATOR = new Uint8Array([
  218, 12, 88, 58, 150, 44, 152, 72,
])

export function getDeactivateProtocolLookupTableDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DEACTIVATE_PROTOCOL_LOOKUP_TABLE_DISCRIMINATOR)
}

export type DeactivateProtocolLookupTableInstruction<
...
export type DeactivateProtocolLookupTableInstructionData = {
  discriminator: ReadonlyUint8Array
  version: bigint
}

export type DeactivateProtocolLookupTableInstructionDataArgs = {
  version: number | bigint
}

export function getDeactivateProtocolLookupTableInstructionDataEncoder(): FixedSizeEncoder<DeactivateProtocolLookupTableInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({
      ...value,
      discriminator: DEACTIVATE_PROTOCOL_LOOKUP_TABLE_DISCRIMINATOR,
    })
  )
}

export function getDeactivateProtocolLookupTableInstructionDataDecoder(): FixedSizeDecoder<DeactivateProtocolLookupTableInstructionData> {
...
export function getDeactivateProtocolLookupTableInstructionDataCodec(): FixedSizeCodec<
  DeactivateProtocolLookupTableInstructionDataArgs,
  DeactivateProtocolLookupTableInstructionData
> {
  return combineCodec(
    getDeactivateProtocolLookupTableInstructionDataEncoder(),
    getDeactivateProtocolLookupTableInstructionDataDecoder()
  )
}

export type DeactivateProtocolLookupTableAsyncInput<
...
> = {
  ...
  version: DeactivateProtocolLookupTableInstructionDataArgs['version']
}

export async function getDeactivateProtocolLookupTableInstructionAsync<
  TAccountPayer extends string,
  TAccountSystemProgram extends string,
  TAccountAddressLookupProgram extends string,
...
>(
  input: DeactivateProtocolLookupTableAsyncInput<
    TAccountPayer,
    TAccountSystemProgram,
    TAccountAddressLookupProgram,
    TAccountAuthority,
  ...
  DeactivateProtocolLookupTableInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountSystemProgram,
    TAccountAddressLookupProgram,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDeactivateProtocolLookupTableInstructionDataEncoder().encode(
      args as DeactivateProtocolLookupTableInstructionDataArgs
    ),
  } as DeactivateProtocolLookupTableInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountSystemProgram,
    TAccountAddressLookupProgram,
...
export type DeactivateProtocolLookupTableInput<
  TAccountPayer extends string = string,
  TAccountSystemProgram extends string = string,
  TAccountAddressLookupProgram extends string = string,
  TAccountAuthority extends string = string,
...
export function getDeactivateProtocolLookupTableInstruction<
  TAccountPayer extends string,
  TAccountSystemProgram extends string,
  TAccountAddressLookupProgram extends string,
  TAccountAuthority extends string,
  ...
  TProgramAddress extends Address = typeof HEAVEN_PROGRAM_ADDRESS,
>(
  input: DeactivateProtocolLookupTableInput<
    TAccountPayer,
    TAccountSystemProgram,
    TAccountAddressLookupProgram,
    TAccountAuthority,
...
export type ParsedDeactivateProtocolLookupTableInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DeactivateProtocolLookupTableInstructionData
}

export function parseDeactivateProtocolLookupTableInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDeactivateProtocolLookupTableInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDeactivateProtocolLookupTableInstructionDataDecoder().decode(instruction.data),
  }
}
