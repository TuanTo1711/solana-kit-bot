...
export const ADMIN_BORROW_SOL_DISCRIMINATOR = new Uint8Array([204, 72, 95, 215, 172, 192, 137, 252])

export function getAdminBorrowSolDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(ADMIN_BORROW_SOL_DISCRIMINATOR)
}

export type AdminBorrowSolInstruction<
...
export type AdminBorrowSolInstructionData = {
  discriminator: ReadonlyUint8Array
  version: number
  amount: bigint
}

export type AdminBorrowSolInstructionDataArgs = {
  version: number
  amount: number | bigint
}

export function getAdminBorrowSolInstructionDataEncoder(): FixedSizeEncoder<AdminBorrowSolInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({ ...value, discriminator: ADMIN_BORROW_SOL_DISCRIMINATOR })
  )
}

export function getAdminBorrowSolInstructionDataDecoder(): FixedSizeDecoder<AdminBorrowSolInstructionData> {
...
export function getAdminBorrowSolInstructionDataCodec(): FixedSizeCodec<
  AdminBorrowSolInstructionDataArgs,
  AdminBorrowSolInstructionData
> {
  return combineCodec(
    getAdminBorrowSolInstructionDataEncoder(),
    getAdminBorrowSolInstructionDataDecoder()
  )
}

export type AdminBorrowSolAsyncInput<
...
> = {
  ...
  version: AdminBorrowSolInstructionDataArgs['version']
  amount: AdminBorrowSolInstructionDataArgs['amount']
}

export async function getAdminBorrowSolInstructionAsync<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
>(
  input: AdminBorrowSolAsyncInput<
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
    TAccountAdmin,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAdminBorrowSolInstructionDataEncoder().encode(
      args as AdminBorrowSolInstructionDataArgs
    ),
  } as AdminBorrowSolInstruction<
    TProgramAddress,
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
...
export type AdminBorrowSolInput<
  TAccountTokenProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountPayer extends string = string,
  TAccountAdmin extends string = string,
...
export function getAdminBorrowSolInstruction<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
export type ParsedAdminBorrowSolInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AdminBorrowSolInstructionData
}

export function parseAdminBorrowSolInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAdminBorrowSolInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAdminBorrowSolInstructionDataDecoder().decode(instruction.data),
  }
}
