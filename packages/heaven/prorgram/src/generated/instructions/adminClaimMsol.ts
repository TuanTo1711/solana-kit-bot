...
export const ADMIN_CLAIM_MSOL_DISCRIMINATOR = new Uint8Array([124, 48, 60, 199, 203, 49, 36, 41])

export function getAdminClaimMsolDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(ADMIN_CLAIM_MSOL_DISCRIMINATOR)
}

export type AdminClaimMsolInstruction<
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountMsolTicketSolSpent extends string
        ? ReadonlyAccount<TAccountMsolTicketSolSpent>
        : TAccountMsolTicketSolSpent,
      ...TRemainingAccounts,
    ]
  >

export type AdminClaimMsolInstructionData = {
  discriminator: ReadonlyUint8Array
  version: number
  ticketNumber: number
}

export type AdminClaimMsolInstructionDataArgs = {
  version: number
  ticketNumber: number
}

export function getAdminClaimMsolInstructionDataEncoder(): FixedSizeEncoder<AdminClaimMsolInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({ ...value, discriminator: ADMIN_CLAIM_MSOL_DISCRIMINATOR })
  )
}

export function getAdminClaimMsolInstructionDataDecoder(): FixedSizeDecoder<AdminClaimMsolInstructionData> {
...
export function getAdminClaimMsolInstructionDataCodec(): FixedSizeCodec<
  AdminClaimMsolInstructionDataArgs,
  AdminClaimMsolInstructionData
> {
  return combineCodec(
    getAdminClaimMsolInstructionDataEncoder(),
    getAdminClaimMsolInstructionDataDecoder()
  )
}

export type AdminClaimMsolAsyncInput<
...
> = {
  ...
  version: AdminClaimMsolInstructionDataArgs['version']
  ticketNumber: AdminClaimMsolInstructionDataArgs['ticketNumber']
}

export async function getAdminClaimMsolInstructionAsync<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
>(
  input: AdminClaimMsolAsyncInput<
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
    TAccountAdmin,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAdminClaimMsolInstructionDataEncoder().encode(
      args as AdminClaimMsolInstructionDataArgs
    ),
  } as AdminClaimMsolInstruction<
    TProgramAddress,
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
...
export type AdminClaimMsolInput<
  TAccountTokenProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountPayer extends string = string,
  TAccountAdmin extends string = string,
...
export function getAdminClaimMsolInstruction<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
export type ParsedAdminClaimMsolInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AdminClaimMsolInstructionData
}

export function parseAdminClaimMsolInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAdminClaimMsolInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAdminClaimMsolInstructionDataDecoder().decode(instruction.data),
  }
}
