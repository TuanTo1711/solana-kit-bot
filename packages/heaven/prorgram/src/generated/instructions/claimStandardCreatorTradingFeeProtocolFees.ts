...
export const CLAIM_STANDARD_CREATOR_TRADING_FEE_PROTOCOL_FEES_DISCRIMINATOR = new Uint8Array([
  0, 201, 226, 228, 127, 45, 69, 110,
])

export function getClaimStandardCreatorTradingFeeProtocolFeesDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLAIM_STANDARD_CREATOR_TRADING_FEE_PROTOCOL_FEES_DISCRIMINATOR
  )
}

export type ClaimStandardCreatorTradingFeeProtocolFeesInstruction<
...
export type ClaimStandardCreatorTradingFeeProtocolFeesInstructionData = {
  discriminator: ReadonlyUint8Array
  amount: bigint
}

export type ClaimStandardCreatorTradingFeeProtocolFeesInstructionDataArgs = {
  amount: number | bigint
}

export function getClaimStandardCreatorTradingFeeProtocolFeesInstructionDataEncoder(): FixedSizeEncoder<ClaimStandardCreatorTradingFeeProtocolFeesInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({
      ...value,
      discriminator: CLAIM_STANDARD_CREATOR_TRADING_FEE_PROTOCOL_FEES_DISCRIMINATOR,
    })
  )
}

export function getClaimStandardCreatorTradingFeeProtocolFeesInstructionDataDecoder(): FixedSizeDecoder<ClaimStandardCreatorTradingFeeProtocolFeesInstructionData> {
...
export function getClaimStandardCreatorTradingFeeProtocolFeesInstructionDataCodec(): FixedSizeCodec<
  ClaimStandardCreatorTradingFeeProtocolFeesInstructionDataArgs,
  ClaimStandardCreatorTradingFeeProtocolFeesInstructionData
> {
  return combineCodec(
    getClaimStandardCreatorTradingFeeProtocolFeesInstructionDataEncoder(),
    getClaimStandardCreatorTradingFeeProtocolFeesInstructionDataDecoder()
  )
}

export type ClaimStandardCreatorTradingFeeProtocolFeesAsyncInput<
...
> = {
  ...
  amount: ClaimStandardCreatorTradingFeeProtocolFeesInstructionDataArgs['amount']
}

export async function getClaimStandardCreatorTradingFeeProtocolFeesInstructionAsync<
  TAccountTokenAProgram extends string,
  TAccountTokenBProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSystemProgram extends string,
...
>(
  input: ClaimStandardCreatorTradingFeeProtocolFeesAsyncInput<
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
    TAccountSystemProgram,
  ...
  ClaimStandardCreatorTradingFeeProtocolFeesInstruction<
    TProgramAddress,
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getClaimStandardCreatorTradingFeeProtocolFeesInstructionDataEncoder().encode(
      args as ClaimStandardCreatorTradingFeeProtocolFeesInstructionDataArgs
    ),
  } as ClaimStandardCreatorTradingFeeProtocolFeesInstruction<
    TProgramAddress,
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
...
export type ClaimStandardCreatorTradingFeeProtocolFeesInput<
  TAccountTokenAProgram extends string = string,
  TAccountTokenBProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountSystemProgram extends string = string,
...
export function getClaimStandardCreatorTradingFeeProtocolFeesInstruction<
  TAccountTokenAProgram extends string,
  TAccountTokenBProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountSystemProgram extends string,
  ...
  TProgramAddress extends Address = typeof HEAVEN_PROGRAM_ADDRESS,
>(
  input: ClaimStandardCreatorTradingFeeProtocolFeesInput<
    TAccountTokenAProgram,
    TAccountTokenBProgram,
    TAccountAssociatedTokenProgram,
    TAccountSystemProgram,
...
export type ParsedClaimStandardCreatorTradingFeeProtocolFeesInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: ClaimStandardCreatorTradingFeeProtocolFeesInstructionData
}

export function parseClaimStandardCreatorTradingFeeProtocolFeesInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedClaimStandardCreatorTradingFeeProtocolFeesInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getClaimStandardCreatorTradingFeeProtocolFeesInstructionDataDecoder().decode(
      instruction.data
    ),
  }
}
