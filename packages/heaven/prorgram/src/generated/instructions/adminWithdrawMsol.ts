...
export const ADMIN_WITHDRAW_MSOL_DISCRIMINATOR = new Uint8Array([
  249, 219, 141, 72, 210, 110, 216, 99,
])

export function getAdminWithdrawMsolDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(ADMIN_WITHDRAW_MSOL_DISCRIMINATOR)
}

export type AdminWithdrawMsolInstruction<
...
export type AdminWithdrawMsolInstructionData = {
  discriminator: ReadonlyUint8Array
  version: number
  amount: bigint
}

export type AdminWithdrawMsolInstructionDataArgs = {
  version: number
  amount: number | bigint
}

export function getAdminWithdrawMsolInstructionDataEncoder(): FixedSizeEncoder<AdminWithdrawMsolInstructionDataArgs> {
  return transformEncoder(
    ...
    value => ({ ...value, discriminator: ADMIN_WITHDRAW_MSOL_DISCRIMINATOR })
  )
}

export function getAdminWithdrawMsolInstructionDataDecoder(): FixedSizeDecoder<AdminWithdrawMsolInstructionData> {
...
export function getAdminWithdrawMsolInstructionDataCodec(): FixedSizeCodec<
  AdminWithdrawMsolInstructionDataArgs,
  AdminWithdrawMsolInstructionData
> {
  return combineCodec(
    getAdminWithdrawMsolInstructionDataEncoder(),
    getAdminWithdrawMsolInstructionDataDecoder()
  )
}

export type AdminWithdrawMsolAsyncInput<
...
> = {
  ...
  version: AdminWithdrawMsolInstructionDataArgs['version']
  amount: AdminWithdrawMsolInstructionDataArgs['amount']
}

export async function getAdminWithdrawMsolInstructionAsync<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
>(
  input: AdminWithdrawMsolAsyncInput<
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
    TAccountAdmin,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAdminWithdrawMsolInstructionDataEncoder().encode(
      args as AdminWithdrawMsolInstructionDataArgs
    ),
  } as AdminWithdrawMsolInstruction<
    TProgramAddress,
    TAccountTokenProgram,
    TAccountAssociatedTokenProgram,
    TAccountPayer,
...
export type AdminWithdrawMsolInput<
  TAccountTokenProgram extends string = string,
  TAccountAssociatedTokenProgram extends string = string,
  TAccountPayer extends string = string,
  TAccountAdmin extends string = string,
...
export function getAdminWithdrawMsolInstruction<
  TAccountTokenProgram extends string,
  TAccountAssociatedTokenProgram extends string,
  TAccountPayer extends string,
  TAccountAdmin extends string,
...
export type ParsedAdminWithdrawMsolInstruction<
  TProgram extends string = typeof HEAVEN_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AdminWithdrawMsolInstructionData
}

export function parseAdminWithdrawMsolInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAdminWithdrawMsolInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAdminWithdrawMsolInstructionDataDecoder().decode(instruction.data),
  }
}
